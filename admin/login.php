...
foreach($db->query('SELECT * FROM admin WHERE id=1') as $row) {
    
	if($_POST['ka'] == $row['ka'] AND $row['sifre'] == md5($_POST['pass']))
	{
	
	$_SESSION['admin44'] ="admin";
...
<head>
  ...
  <title>Bordemir Giriş Paneli</title>
...
<body>
  ...
  <form id="login_form" method="post" action="">
    <div class="field_container">
      <input type="text" placeholder="Kullanıcı adınız" name="ka">
    </div>

    <div class="field_container">
      <input type="Password" placeholder="Şifreniz" name="pass">
      <button id="sign_in_button">
        <span class="button_text">Giriş</span>
      </button>
    </div>
