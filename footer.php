...
<div class="sosyal1">	<img src="img/facebook.jpg" /><a class="link" href="http://facebook.com/<?php echo $row['facebook']; ?>"> <p class="sosyal">/ <?php echo $row['facebook']; ?></a><hr width="170px" size="1" color="#fff" align="left" style="margin-top:-15px;margin-left:48px;" /></p></div>
<div class="sosyal1"><img src="img/twitter.jpg" /><a class="link" href="http://twitter.com/<?php echo $row['twitter']; ?>"><p class="sosyal"> / <?php echo $row['twitter']; ?> </a><hr width="170px" size="1" color="#fff" align="left" style="margin-top:-15px;margin-left:48px;"/></p></div>
<div class="sosyal1"><img src="img/instagram.jpg" /><a class="link" href="http://instagram.com/<?php echo $row['instagram']; ?>"><p class="sosyal"> / <?php echo $row['instagram']; ?></a> <hr width="170px" size="1" color="#fff" align="left" style="margin-top:-15px;margin-left:48px;" /></p></div>
<?php } ?>
	</div>
